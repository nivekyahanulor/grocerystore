	...
	<div class="col-lg-12">
		<div class="row mt-3">
			<div class="col-md-12">
				...
				<li class="nav-item">
				  <a class="nav-link active" href="index.php?page=inventory_reports">Inventory Reports</a>
				</li>
			  </ul>
				...
				<div class="card">
					...
					<div class="card-body">
						<table class="table table-bordered">
							...
							<?php 
								$i = 1;
								$product = $conn->query("SELECT a.* , b.* FROM inventory a left join product_list b on a.product_id = b.id where a.type =2  order by date_updated asc");
