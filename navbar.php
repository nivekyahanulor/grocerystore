...
<style>
	a.nav-item {
    color: white;
    background-color: #dc8d04dd;
    
}
a.nav-item:hover, .nav-item.active {
    background-color: #f5b623bc;
    
}
</style>
<nav id="sidebar" class="mx-lt-5" style="background-color: #decfad;">
		
		<div class="sidebar-list">

				<a href="index.php?page=home&data=daily" class="nav-item nav-home"><span class='icon-field'><i class="fa fa-home"></i></span> Home</a>
				...
				<a href="index.php?page=reports" class="nav-item nav-reports"><span class='icon-field'><i class="fa fa-bar"></i></span> Reports </a>
